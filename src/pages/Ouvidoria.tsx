            ...
            >
              <div>
                ...
                <p className="text-lg text-gray-600 leading-relaxed mb-6">
                  A Ouvidoria da Integral Dental é um canal de comunicação independente
              ...
              <div className="bg-gradient-to-br from-primary to-primary-dark text-white p-10 rounded-3xl shadow-2xl">
                ...
                <p className="text-lg text-white/90">
                  A partir da data de registro na Ouvidoria, você receberá um retorno
                  sobre sua demanda.
                </p>
              </div>
            </motion.div>
          ...
          >
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-12">
              ...
              >
                ...
                <h3 className="text-2xl font-black text-gray-900 mb-3">Telefone da Ouvidoria</h3>
